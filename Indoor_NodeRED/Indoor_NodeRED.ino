...
String URL = "https://partially-unique-haddock.ngrok-free.app/post_indoor";
...
const unsigned long interval = 60000; // Interval for HTTP POST in milliseconds (15 seconds)
...
void setup() {
  ...
  // Initialize BME280 sensor with I2C address 0x76
  ...
  timeClient.begin();
  timeClient.setTimeOffset(9 * 3600); // Set time offset (in seconds, 9 hours for JST)
...
void addSensorData(JsonArray& dataArr, const char* measurementType, String value, String status) {
  ...
  String assetType = "Indoor";
  String assetUUID = "7d95abe7-a9c2-4014-bf53-4259705e6bce";
  ...
  if (strcmp(measurementType, "temperature") == 0) {
    deviceUUID = "fbcdffbb-539c-4445-a1ac-b23dfc9d742a";
    dataValue = value;
    dataUnit = "°C";
